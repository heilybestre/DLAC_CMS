          ...
          <div class="modal-body" style='margin: 0 0 0 20px;'>
            ...
            <div class="col-sm-8 control-group">
              <div class="controls">
                <h5>
                  <?php
                  foreach ($caseinterns as $intern) {
                    if ($intern->condition == 'applytotransfer') {
                      echo $intern->reason;
                    }
                  }
                  ?>
            ...
            <div class="col-sm-8 control-group">
              <div class="controls">
                <h5>
                  ...
                  foreach ($caseinterns as $intern) {
                    if ($intern->condition == 'applytotransfer') {
                      echo $this->People_model->getuserfield('firstname', $intern->personID) . ' ' . $this->People_model->getuserfield('lastname', $intern->personID);
                    }
                  }
                  ?>
                </h5>
