    ...
    <?php if ($actionplanstatus == null) { ?>
        ...
        <div id='actionplandiv' class="row disable fadedopp">
            ...
            <div class="well todo col-lg-2" style="padding:10px; margin-left:2px;">
                ...
                <ul class="todo-list">
                    <table id='action1table' class="table table-condensed disable" style="background-color:white;">
                        <tr>
                            <td><input type='checkbox' name='action1[]' value='Set Client Meeting' style='margin: 0px 5px 0px 10px;' /></td>
                            <td><input name='actionname1[]' value='Set Client Meeting' class='hide'> Set Client Meeting </td>
                        </tr>
                        <tr>
                            <td><input type='checkbox' name='action1[]' value='Inform Client' style='margin: 0px 5px 0px 10px;' /></td>
