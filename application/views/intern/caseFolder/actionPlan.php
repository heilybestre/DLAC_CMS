    ...
    <?php if ($actionplanstatus == null) { ?>
        ...
        <div id='actionplandiv' class="row disable fadedopp">
            ...
            <div id='saveactionplanbtndiv' class="col-lg-1 hide">
                <button class="btn btn-medium btn-info" style="margin-bottom:10px">Save Action Plan</button>
            </div>
            ...
            <div id='cancelactionplanbtndiv' class="col-lg-1 hide">
                <button class="btn btn-medium btn-default" style="margin-bottom:10px">Cancel</button>
            </div>

            <br><br><br>

            <!-- 1 NEW || MAKE ALL CHECKBOX DISABLED-->
            <div class="well todo col-md-3" style="padding:10px; margin-left:2px;">
                <h3> New
                </h3> 
                <ul class="todo-list">
                    <table id='action1table' class="table table-condensed" style="background-color:white;">
                        <?php foreach ($actions1 as $action): ?>
                            <tr>
                                <td><input class="disable" type='checkbox' name='action1[]' value='<?= $action->rapID ?>' style='margin: 0px 5px 0px 10px;' /></td>
                                <td>
                                    <input name='actionname1[]' value='<?= $action->rapID ?>' class='hide'> <?= $action->action ?>
                ...
                <ul class="todo-list">
                    <table id='action2table' class='table table-condensed disable' style='background-color:white;'>
                        <?php foreach ($actions2 as $action) : ?>
                            <tr>
                                <td><input type='checkbox' name='action2[]' value='<?= $action->rapID ?>' style='margin: 0px 5px 0px 10px;' /></td>
                                <td>
                                    <input name='actionname2[]' value='<?= $action->rapID ?>' class='hide'> <?= $action->action ?>
                                    <a href="#" id="popover-editing" data-placement="bottom" class="btn btn-success popover-editing pull-right"> <i class="icon-caret-down"></i> </a>
                                    <div id="popover-editing-head" class="hide popover-editing-head"></div>
                                    <div id="popover-editing-content" class="hide popover-editing-content">
                                        <form>
                ...
                <ul class="todo-list">
                    <table id='action3table' class='table table-condensed disable' style='background-color:white;'>
                        <?php foreach ($actions3 as $action): ?>
                            <tr>
                                <td><input class="disable" type='checkbox' name='action3[]' value='<?= $action->rapID ?>' style='margin: 0px 5px 0px 10px;' /></td>
                                <td>
                                    <input name='actionname3[]' value='<?= $action->rapID ?>' class='hide'> <?= $action->action ?>
                                    <a href="#" id="popover-editing" data-placement="bottom" class="btn btn-success popover-editing pull-right"> <i class="icon-caret-down"></i> </a>
                                    <div id="popover-editing-head" class="hide popover-editing-head"></div>
                                    <div id="popover-editing-content" class="hide popover-editing-content">
                                        <form>
            ...
            <div class="clearfix well todo col-lg-2" style="padding:10px;">
                ...
                <ul class="todo-list">
                    <table id='action4table' class='table table-condensed disable' style='background-color:white;'>
                       <?php foreach ($actions4 as $action): ?>
                            <tr>
                                <td><input class="disable" type='checkbox' name='action4[]' value='<?= $action->rapID ?>' style='margin: 0px 5px 0px 10px;' /></td>
                                <td>
                                    <input name='actionname4[]' value='<?= $action->rapID ?>' class='hide'> <?= $action->action ?>
                                    <a href="#" id="popover-editing" data-placement="bottom" class="btn btn-success popover-editing pull-right"> <i class="icon-caret-down"></i> </a>
                                    <div id="popover-editing-head" class="hide popover-editing-head"></div>
                                    <div id="popover-editing-content" class="hide popover-editing-content">
                                        <form>
                ...
                <ul class="todo-list">
                    <table id='action1table' class="table table-condensed" style="background-color:white;">
                        ...
                        <?php foreach ($actionplan_stage1 as $action) : ?>
                            <tr>
                                <td><input class='cbactionstage1' type='checkbox' value="<?= $action->actionplanID ?>" style='margin: 0px 5px 0px 10px;' onclick="actionclick(<?= $action->actionplanID ?>, 1, <?= $case->stage ?>)" <?php
                                    if ($action->status == 1) {
                                        echo 'checked';
                                    }
                                    ?> /></td>
