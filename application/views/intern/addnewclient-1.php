    ...
    <br>
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<br>
					<?php echo form_open(base_url() . 'people/addnewclient', array('class' => 'form-horizontal')); ?>
					...
					<div class="col-sm-3 control-group">
						...
						<div class="col-sm-3 control-group">
							<div class="controls">
								<?php echo form_input(array('placeholder' => 'Area', 'id' => 'clientAddressDistrict', 'name' => 'clientAddressDistrict', 'type' => 'text', 'class' => 'form-control' )); ?>
							</div>
						</div>
						...
						<div class="col-sm-9 control-group">
							<div class="controls">
								<?php echo form_input(array('id' => 'rbContact', 'name' => 'rbContact', 'type' => 'text', 'class' => 'form-control' )); ?>
							</div>
						</div>
