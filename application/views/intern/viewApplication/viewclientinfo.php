    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="col-sm-8 control-group">
                <div class="controls">
                    <h5>
                        <?php if ($client->contacthome != null) {
                            echo $client->contacthome . ' (Home) | ';
                        } ?>
                        <?php if ($client->contactoffice != null) {
                            echo $client->contactoffice . ' (Office) | ';
                        } ?>
                        <?php if ($client->contactmobile != null) {
            ...
            <div class="col-sm-9 control-group">
                <div class="controls">
                    <h5><?php if ($client->emailaddr == '' || $client->emailaddr == NULL) echo '-';
                    else echo $client->emailaddr; ?></h5>
                </div>
            </div>
            ...
            <div class="col-sm-9 control-group">
                <div class="controls">
                    <h5><?php if ($client->fbemailaddr == '' || $client->fbemailaddr == NULL) echo '-';
                    else echo $client->fbemailaddr; ?></h5>
                </div>
            </div>
            ...
            <div class="col-sm-9 control-group">
                <div class="controls">
                    <h5><?php if ($client->referredby == '' || $client->referredby == NULL) echo '-';
                    else echo $client->referredby; ?></h5>
                </div>
            </div>
            ...
            <div class="col-sm-9 control-group">
                <div class="controls">
                    <h5><?php if ($client->rbcontact == '' || $client->rbcontact == NULL) echo '-';
                    else echo $client->rbcontact; ?></h5>
                </div>
            </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="col-sm-8 control-group">
                <div class="controls">
                    <h5><?php if ($client->birthplace == '' || $client->birthplace == NULL) echo '-';
                    else echo $client->birthplace; ?></h5>
                </div>
            </div>
            ...
            <div class="col-sm-8 control-group">
                <div class="controls">
                    <h5><?php if ($client->occupation == '' || $client->occupation == NULL) echo '-';
                    else echo $client->occupation; ?></h5>
                </div>
            </div>
            ...
            <div class="col-sm-8 control-group">
                <div class="controls">
                    <h5>&nbsp;<?php if ($client->organization == '' || $client->organization == NULL) echo '-';
                    else echo $client->organization; ?></h5>
                </div>
            </div>
            ...
            <div class="col-sm-8 control-group">
                <div class="controls">
                    <h5><?php if ($client->organizationaddr == '' || $client->organizationaddr == NULL) echo '-';
                    else echo $client->organizationaddr; ?></h5>
                </div>
            </div>
