				...
				<table id='docevidencetable' class="table table-striped table-bordered datatable" style="background-color:#f8f8f8;">
					<thead>
						<tr>
							...
							<th style='display:none;'>Date issued</th>
							<th style='display:none;'>Place issued</th>
							<th style='display:none;'>Date received</th>
							<th style='display:none;'>Evidence of</th>
						</tr>
					</thead>
					<tbody>
					</tbody>
				...
				<table id='objevidencetable' class="table table-striped table-bordered datatable" style="background-color:#f8f8f8;">
					<thead>
						<tr>
							...
							<th style='display:none;'>Desc</th>
							<th style='display:none;'>Date received</th>
							<th style='display:none;'>Date retrieved</th>
							<th style='display:none;'>Evidence of</th>
						</tr>
					</thead>
					<tbody>
				...
				<table id='tesevidencetable' class="table table-striped table-bordered datatable" style="background-color:#f8f8f8;">
					<thead>
						<tr>
							...
							<th style='display:none;'>Purpose</th>
							<th style='display:none;'>Narrative</th>
							<th style='display:none;'>Evidence of</th>
						</tr>
					</thead>
					<tbody>
...
<!-- MODALS -->
<div class="row">
	<!-- START OF ADD PERSON TO TESTIFY DOC MODAL -->
	<div class="modal fade" id="addPerSonToTestifyDoc">
		<div class="modal-dialog-evidence">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'First', 'id' => 'docpersonFirstName', 'name' => 'docpersonFirstName', 'type' => 'text', 'class' => 'form-control')); ?>
						</div> 
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Middle', 'id' => 'docpersonMiddleName', 'name' => 'docpersonMiddleName', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>   
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Last', 'id' => 'docpersonLastName', 'name' => 'docpersonLastName', 'type' => 'text', 'class' => 'form-control')); ?>   
						</div>   
					</div>
					...
					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'House', 'id' => 'docpersonAddressHouseNo', 'name' => 'docpersonAddressHouseNo', 'type' => 'text', 'class' => 'form-control')); ?>      
						</div>
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Street', 'id' => 'docpersonAddressStreet', 'name' => 'docpersonAddressStreet', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Area', 'id' => 'docpersonAddressDistrict', 'name' => 'docpersonAddressDistrict', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>
					...
					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Town', 'id' => 'docpersonAddressTown', 'name' => 'docpersonAddressTown', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Postal Code', 'id' => 'docpersonAddressPostalCode', 'name' => 'docpersonAddressPostalCode', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>
					...
					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Home', 'id' => 'docpersonCNHome', 'name' => 'docpersonCNHome', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Office', 'id' => 'docpersonCNOffice', 'name' => 'docpersonCNOffice', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Mobile', 'id' => 'docpersonCNMobile', 'name' => 'docpersonCNMobile', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>
					<br><br>
				</div>
				...
				<div class="modal-footer">
					<button id='btnaddpersondoc' class="btn btn-success" data-dismiss="modal" aria-hidden="true">Add Person</button>
					<button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
				</div>
			</div>
		</div>
	</div>
	<!-- END OF ADD PERSON TO TESTIFY DOC MODAL -->

	<!-- START OF ADD PERSON TO TESTIFY OBJ MODAL -->
	<div class="modal fade" id="addPerSonToTestifyObj">
		<div class="modal-dialog-evidence">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				...
				<div class="modal-footer">
					<button id='btnaddpersonobj' class="btn btn-success" data-dismiss="modal" aria-hidden="true">Add Person</button>
					<button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
				</div>
			</div>
		</div>
	</div>
	<!-- END OF ADD PERSON TO TESTIFY OBJ MODAL -->

	<!-- START OF ADD TESTI PERSON MODAL -->
	<div class="modal fade" id="addTestiPerson">
		<div class="modal-dialog-evidence">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				...
				<div class="modal-body">
					...
					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'First', 'id' => 'tespersonFirstName', 'name' => 'tespersonFirstName', 'type' => 'text', 'class' => 'form-control')); ?>
						</div> 
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Middle', 'id' => 'tespersonMiddleName', 'name' => 'tespersonMiddleName', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>   
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Last', 'id' => 'tespersonLastName', 'name' => 'tespersonLastName', 'type' => 'text', 'class' => 'form-control')); ?>   
						</div>   
					</div>
					...
					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'House', 'id' => 'tespersonAddressHouseNo', 'name' => 'tespersonAddressHouseNo', 'type' => 'text', 'class' => 'form-control')); ?>      
						</div>
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Street', 'id' => 'tespersonAddressStreet', 'name' => 'tespersonAddressStreet', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Town', 'id' => 'tespersonAddressTown', 'name' => 'tespersonAddressTown', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>
					...
					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'District', 'id' => 'tespersonAddressDistrict', 'name' => 'tespersonAddressDistrict', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Postal Code', 'id' => 'tespersonAddressPostalCode', 'name' => 'tespersonAddressPostalCode', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>
					...
					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Home', 'id' => 'tespersonCNHome', 'name' => 'tespersonCNHome', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Office', 'id' => 'tespersonCNOffice', 'name' => 'tespersonCNOffice', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>

					<div class="col-sm-3 control-group">
						<div class="controls">
							<?php echo form_input(array('placeholder' => 'Mobile', 'id' => 'tespersonCNMobile', 'name' => 'tespersonCNMobile', 'type' => 'text', 'class' => 'form-control')); ?>
						</div>
					</div>
					<br><br>
				</div>
				...
				<div class="modal-footer">
					<button id='btnaddpersontes' class="btn btn-success" data-dismiss="modal" aria-hidden="true">Add Person</button>
					<button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
				</div>
			</div>
		</div>
	</div>
	<!-- END OF ADD TESTI PERSON MODAL -->
</div>
</div>
