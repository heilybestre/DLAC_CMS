    ...
    <div class="modal fade" id="applyToTransferModal2">
      <div class="modal-dialog-applyToTransfer">
        <div class="modal-content">
          ...
          <div class="modal-body" style="margin: 0 0 0 40px;">
    ...
    <div class="modal fade" id="applyToCloseModal2">
      <div class="modal-dialog-applyToClose">
        <div class="modal-content">
          ...
          <div class="modal-body" style='margin: 0 0 0 20px;'>
            <div class="col-sm-3 control-group">
              <div class="controls">
                <center> <h5> <b> Case Title: </b> </h5> </center>
              </div>
              ...
              <table class="table table-striped table-bordered">
                <tr>
                  <td>
                    ...
                    <?php echo form_textarea(array('id' => 'addStrategies', 'name' => 'addStrategies', 'type' => 'text', 'class' => 'form-control', 'style' => 'height:130px;')); ?>
                  </td>
                </tr>
                <tr>
                  <td>
                    ...
                    <?php echo form_textarea(array('id' => 'addStrengths', 'name' => 'addStrengths', 'type' => 'text', 'class' => 'form-control', 'style' => 'height:130px;')); ?>
                  </td>
                </tr>
                <tr>
                  <td>
                    ...
                    <?php echo form_textarea(array('id' => 'addWeaknesses', 'name' => 'addWeaknesses', 'type' => 'text', 'class' => 'form-control', 'style' => 'height:130px;')); ?>
                  </td>
                </tr>
                <tr>
                  <td>
                    ...
                    <?php echo form_textarea(array('id' => 'addOpportunities', 'name' => 'addOpportunities', 'type' => 'text', 'class' => 'form-control', 'style' => 'height:130px;')); ?>
                  </td>
                </tr>
                <tr>
                  <td>
                    ...
                    <?php echo form_textarea(array('id' => 'addThreats', 'name' => 'addThreats', 'type' => 'text', 'class' => 'form-control', 'style' => 'height:130px;')); ?>
                  </td>
                </tr>
              </table>
            </div>
