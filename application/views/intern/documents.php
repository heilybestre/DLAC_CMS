...
<div id="content" class="col-lg-10 col-sm-11">
    <?php echo form_open(base_url() . 'intern/documents', array('class' => 'form-horizontal')); ?>

    <div class="row pull-right">
        <!-- Button to trigger modal -->
        &nbsp;&nbsp;&nbsp;
        <a class ="btn btn-medium btn-success" style='margin-bottom: 10px' href="#addDraftModal" data-toggle="modal">
            <i class="icon-plus-sign"></i>&nbsp;Add New Draft</a>&nbsp;
