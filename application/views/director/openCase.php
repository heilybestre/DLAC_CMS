...
<div id="content" class="col-lg-12 col-sm-11">
    ...
    <div class="row">
        ...
        <div class="box col-lg-6">
            <?php echo form_open(base_url() . "cases/openCase/$case->caseID", array('class' => 'form-horizontal')); ?>
            ...
            <div class="box-content box-content-openCase">
                ...
                <div class="well" style="padding:10px; background-color:white;">
                    ...
                    <h5><b>Offense:</b> <?php
                        foreach ($caseoffense as $off) {
                            echo "$off->offenseName $off->stage";
                        }
                        ?></h5>
                    <h5><b>Current Stage:</b> <?php echo $case->stageName ?></h5>                
                    <h5><b>Assigned Lawyer:</b> <?php
                        foreach ($lawyers as $lawyer) {
                            echo "$lawyer->firstname $lawyer->lastname";
                        }
                        ?></h5>
                    <h5><b>Assigned Interns:</b> <?php
                        foreach ($interns as $intern) {
                            echo "$intern->firstname $intern->lastname ";
                        }
                        ?></h5>
                </div>
