...
<?php echo form_open(base_url() . 'director/docClient', array('class' => 'form-horizontal')); ?>  <!-- START OF DOC BY CLIENT -->
...
<?php echo form_open(base_url() . 'director/docOpposing', array('class' => 'form-horizontal')); ?> <!-- START OF DOC BY OPPOSING -->
...
<?php echo form_open(base_url() . 'director/docCourt', array('class' => 'form-horizontal')); ?>  <!-- START OF DOC FROM THE COURT -->
        ...
        <div class="modal fade" id="viewDocClient">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">Pleading/Motion by the Client</h4>
                    </div>
                    <div class="modal-body">
        ...
        <div class="modal fade" id="viewDocOpposing">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">Pleading/Motion by the Opposing Party</h4>
                    </div>
                    <div class="modal-body">
