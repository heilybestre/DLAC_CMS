...
<div class="container">
    ...
    <?php echo form_open(base_url() . 'secretary/task', array('class' => 'form-horizontal')); ?>
        ...
        <div id="addTaskModalDir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <?php echo form_open(base_url() . 'secretary/addPersonalTask', array('class' => 'form-horizontal')); ?> <!-- START OF DOCUMENTARY EVIDENCE -->
                    ...
                    <?php echo form_open(base_url() . 'secretary/addRequiredTask', array('class' => 'form-horizontal')); ?> <!-- START OF DOCUMENTARY EVIDENCE -->
